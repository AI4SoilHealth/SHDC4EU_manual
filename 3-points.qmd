...
#from misc import find_files, nan_percentile, GoogleSheet, ttprint
from harmonization_helper import plot_subplots_histogram, conversion, plot_spatial_distribution
```
```{python}
#| echo: true
#| results: as-is
...
def find_soil_dataset(directory):
    ...
    for dirpath,_,filenames in os.walk(directory):
        for f in filenames:
            if 'all_harmonized_v20250723.pq' in f:
...
meta_cols = ['id', 'lat', 'lon', 'year', 'hzn_top', 'hzn_btm', 'ref', 'nuts0']  # columns to indicate meta information
...
num_cols = ['lat', 'lon', 'year', 'hzn_top', 'hzn_btm'] + prop_cols
for col in num_cols:
...
creds = ServiceAccountCredentials.from_json_keyfile_name('/mnt/lacus/ai4sh_data.harmo/gaia-319808-913d36b5fca4.json', scope)

# Authorize and open the sheet
client = gspread.authorize(creds)
spreadsheet = client.open_by_url(
    'https://docs.google.com/spreadsheets/d/1J652XU_VWmbm1uLmeywlF6kfe7fUD5aJrfAIK97th1E/edit#gid=1254448729'
)

# Select the “soc” sheet
mdf = spreadsheet.worksheet('soc')
```
...
dff = conversion(data, mdf, prop,dataset_colum_name="ref") 
print(dff)
# sampled_rows = (
